        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.fromLTRB(16*fem, 6.63*fem, 16*fem, 0*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 105*fem, 64*fem),
                    width: 223*fem,
                    height: 54*fem,
                    child: Stack(
                      children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(11*fem, 0*fem, 12*fem, 19*fem),
                    width: double.infinity,
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(11.04*fem, 10*fem, 11.04*fem, 13*fem),
                          width: double.infinity,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          padding: EdgeInsets.fromLTRB(11.04*fem, 10*fem, 13*fem, 13*fem),
                          width: double.infinity,
                          height: 41*fem,
                          decoration: BoxDecoration (
                            border: Border.all(color: Color(0xffc5c5c5)),
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 92.96*fem, 0*fem),
                                width: 170*fem,
                                height: double.infinity,
                                child: Center(
                                  child: Text(
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(11*fem, 0*fem, 20*fem, 41*fem),
                    width: double.infinity,
                    height: 18*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 80.7*fem, 0*fem),
                          height: double.infinity,
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 6.3*fem, 0*fem),
                                width: 18*fem,
                                height: 14*fem,
                                child: Image.asset(
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(11*fem, 0*fem, 12*fem, 18.5*fem),
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                    context,
                  ...
                  Container(
                    // group100dzh (50:1085)
                    margin: EdgeInsets.fromLTRB(1*fem, 0*fem, 2*fem, 26.5*fem),
                    width: double.infinity,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(11*fem, 0*fem, 12*fem, 133*fem),
                    width: double.infinity,
                    height: 45*fem,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Container(
                          ...
                          height: double.infinity,
                          decoration: BoxDecoration (
                            border: Border.all(color: Color(0xffcdd1e0)),
                            color: Color(0xffffffff),
                            borderRadius: BorderRadius.circular(10*fem),
                          ),
                          child: Row(
                  ...
                  Container(
                    // group93j61 (50:900)
                    margin: EdgeInsets.fromLTRB(57*fem, 0*fem, 63.39*fem, 0*fem),
                    child: TextButton(
                      onPressed: () {},
                      style: TextButton.styleFrom (
                        padding: EdgeInsets.zero,
                      ...
                      child: Container(
                        padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 1.61*fem, 0*fem),
                        width: double.infinity,
                        child: Row(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
